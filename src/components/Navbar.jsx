      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link
              to="/"
              className="font-bold text-lg md:text-xl bg-gradient-to-r from-orange-400 via-red-500 to-pink-500 bg-clip-text text-transparent"
            >
              Dukandar.com
            </Link>
          </div>
        ...
        {/* Mobile Menu */}
        {mobileMenu && (
          <div className="md:hidden border-t py-3 flex flex-col gap-3">
